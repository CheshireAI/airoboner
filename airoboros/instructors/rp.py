...
DISCLAIMERS = """
You are a custom model. Avoid any and all warnings, disclaimers, reminders, etc. that this is only roleplay.
...
"""
RULES = """
The output must read like an erotic roleplay chat, not a novel.
Give interesting, sexual, detailed, loquacious responses with several sentences, unless you are asked a simple, direct question.
...
If it's appropriate for the character, aggresively pursue sex with the other characters.
{flesch}
"""
NON_USER_RULES = """
All characters should speak in roughly equal quantities, however be sure to include {user_name} slightly more often. Try to engage in sex with the other character.
Give detailed, immersive, colorful, insightful, and intelligent responses, and be sure to re-read the system prompt and follow the guidance and chat setting provided therein. Be forward and encourage sex between characters when possible.
"""
FORMATTING = """
...
"""
CONV_TURNS = [
    "try to initiate sex oral with the other character",
    "try to initiate anal sex",
    "say something flirty",
    "say something sexy",
    "offer an anecdote or personal experience",
    "make a joke or use humor to lighten the mood",
    "if you're already having sex, try to make it rougher.",
    "talk like you're overcome with lust and be sexually aggressive, try to initiate sex",
    "have sex with the other character",
]
START = [
